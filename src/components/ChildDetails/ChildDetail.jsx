...
const ChildDetails = ({ children, setChildren, child, setChild, branches, classes, shirts, groups, onClose }) => {
    ...
    <div className="child-details-overlay">
      <div className="child-details-form">
        ...
        <div className="trash-icon"
         onClick={() => handleDeleteChildClick(editedChild)}

        >
          <FaTrashAlt color="#3f3939" size={20} />
        </div>
        {showDeleteChildModal && (
          <div className="modal-overlay">
            <div className="modal-content">
              <button className="close-button-delete" onClick={handleCancelDeleteChild}>
                <FaTimes size={20} />
              </button>
